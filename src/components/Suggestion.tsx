  ...
  return (
    <div className='bg-white w-80 h-80 ml-4 mt-5 rounded-md'>
      <div className='flex justify-between pt-3'>
        <p className='font-bold ml-3 tracking-wider text-black'>Suggested For You</p>
      ...
      {suggestedUsers.map((user: any) => (
        ...
        >
          ...
          <div className='flex flex-col'>
            <p className='font-semibold text-black'>{user.userName} {user.premium?<FontAwesomeIcon icon={faCheckCircle} color='#2892FF' />:""}</p>
